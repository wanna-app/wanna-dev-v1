...
const styles = StyleSheet.create({
  ...
  dotsRow: {
    position: "absolute",
    // Sits just below the iOS safe-area notch. Profile/UserProfile
    // chrome (paddingTop:18 inside its own SafeAreaView) sits ~11pt
    // below the bars — tight cluster, no awkward void.
    top: 54,
    left: 16,
    right: 16,
    flexDirection: "row",
